<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select id="gender" class="block mt-1 w-full" name="gender" wire:model.defer="state.gender">


                <option value=""> -- Select Gender --</option>
                <option value="laki-laki" {{ $this->user->gender== 'laki-laki' ? 'selected' : '' }}>
                    Laki-laki
                </option>
                <option value="perempuan" {{ $this->user->gender== 'perempuan' ? 'selected' : '' }}>
                    Perempuan
                </option>
